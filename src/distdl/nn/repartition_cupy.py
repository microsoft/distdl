...
class Repartition(Module):
    ...
    def __init__(self, P_x, P_y, preserve_batch=True, buffer_manager=None):
        ...
        # ToDO: Unsure of how to convert TensorStructure objects, yet. -> leave for now
        ...
        if buffer_manager is None:
            # ToDO: Set the buffer manager later - done
        ...
        # ToDO: what do these allgathers do? just parameter passing (?) - sync
        ...
        self.allocate_repartition_buffers = self._distdl_backend.repartition_cupy.allocate_repartition_buffers
    ...
    def forward(self, input):
        ...
        Function = self._distdl_backend.functional.repartition_cupy.RepartitionFunction
