...
from distdl.backends.mpi_mpi_cupy.compare import check_identical_comm
from distdl.backends.mpi_mpi_cupy.compare import check_identical_group
from distdl.backends.mpi_mpi_cupy.compare import check_null_comm
...
class MPIPartition:
    ...
    def broadcast_data(self, data, root=0, P_data=None):
        ...
        data_dtype = intID_to_cupy_dtype_dict[data_dtype[0]]
    ...
    def allreduce_data(self, data, op="sum"):
        ...
        from distdl.backends.mpi_mpi_cupy import operation_map
