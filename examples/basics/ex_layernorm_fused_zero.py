...
from distdl.nn.layernorm_zero_fused import DistributedFusedLayerNormZero
...
# Layer norm
layer_norm = DistributedFusedLayerNormZero(P_x, normalized_shape, collect_state=True)
