...
from distdl.nn.conv_zero_ag import DistributedZeroAGConv2d
...
conv2d = DistributedZeroAGConv2d(P_x, 16, 16, (3, 3), padding=(1, 1), device=P_x.device, checkpointing=True)
y = conv2d(x)
